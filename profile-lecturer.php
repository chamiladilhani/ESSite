...
<div id="wrapper">
	...
	<div id="maincontentcontainer" class="s_design">
		<div id="maincontent">
                	...
                	<div class="proList">
	                    <ul>
                            ...
                            <li>
	                            ...
	                            <img class="proImg" src="img/prop.jpg">

	                            <div class="proDetails">
	                                <span class="proTitle">Chinthana Wijekoon </span>
	                                <p class="contactJobtitle">Chief Technical Officer</p>
	                                <p class="contactJobtitle"  style="color:#555">@ Datacore Technologies</p>
	                                <p class="contactJobtitle" style="color:#77A22F">Sri Lanka – Information Technology</p>
	                                <span class="proAddress">17, Dalada Veediya<br />Kandy<br />Srilanka<br /></span>
	                            </div>

	                            <div class="proContact">
	                            <span class="proWebsite"><img src="img/icons/icon-tel.png" width="14" height="13" alt="Tel"> +94 (0)713 789 660</span>
	                            <span class="proEmail"><img src="img/icons/icon-email.png" width="14" height="12" alt="Email"> <a href="mailto:chinthana@gmail.com">chinthana@gmail.com</a></span>
                ...
                <div class="col span_1_of_4 pg_aside">
                	<div class="also_in">
			        	...
			        	<ul class="accordion-box-content acl1">
							...
							<li>&rsaquo; <a href="#">Lecture Schedule</a></li>
						
							<li>&rsaquo; <a href="#">Deactivate</a></li>
