	...
	<div id="maincontentcontainer" class="s_contact">
		<div id="maincontent">
			...
			<div class="breadcrumb">
            	<a href="index.php">Home</a> &raquo; <a href="organizer-panel.php">Organizer</a> &raquo; Event Schedule
            </div>
			...
			<div class="section group">
                ...
                <div class="col span_3_of_5">              	
                	<h3 style="text-align:center;background:#42B8DD"><span style="color:#fff" class="contactJobtitle">Event Schedule</span></h3>
            		<div class="section group" style="background:#DDD;">            		
	            		...
	            		<h3><span style="color:#555;margin-left:10px;" class="contactJobtitle">Existing List</span></h3>
							<?php
								$userList = $user->getPastEventsView();
								...
								if($userList){
									...
									<table>
									    <thead>
									        <tr>
									            ...
									            <th scope="col" style="text-align:center">Organizer</th>
									        </tr>
									    </thead>
									...
									foreach($userList as $singleUser){
										...
										$lecturerData = $lecturer->getLecturerName($singleUser->electurer);
										
										echo '
											<tr class="pure-table-odd">
									            <td>'.$singleUser->id.'</td>
									            <td><a href="event-more.php?eid='.$singleUser->id.'">'.$singleUser->ename.'</a></td>
									            <td>'.$lecturerData->fname.' '.$lecturerData->lname.' </td>
									            <td>'.$singleUser->edate.'</td>
									            <td>'.$singleUser->ehour.':'.$singleUser->eminute.' - '.$singleUser->ehour_to.':'.$singleUser->eminute_to.'</td>
									            <td>'.$singleUser->organizer_name.'</td>
									        </tr>
										';								
									}
									echo '
