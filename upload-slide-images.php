...
$BigImageMaxSize 		= 1192; //Image Maximum height or width
$ThumbPrefix			= "thumb_"; //Normal thumb Prefix
$DestinationDirectory	= 'uploads/slides/'; //Upload Directory ends with / (slash)
$Quality 				= 90;
			...
			if($processImage && resizeImage($CurWidth,$CurHeight,$BigImageMaxSize,$DestRandImageName,$CreatedImage,$Quality,$ImageType[$i]))
			{
				...
				if(!cropImage($CurWidth,$CurHeight,$ThumbSquareSize,$thumb_DestRandImageName,$CreatedImage,$Quality,$ImageType[$i]))
					...
					*/
					...
					echo '<tr>';
					echo '<td align="center"><img style="width:20%;" src="uploads/slides/'.$ThumbPrefix.$NewImageName.'" alt="Thumbnail" height="'.$ThumbSquareSize.'" width="'.$ThumbSquareSize.'"></td>';
					echo '</tr><tr>';
					echo '<td align="center"><img style="width:50%;" src="uploads/slides/'.$NewImageName.'" alt="Resized Image" height="'.$ResizedHeight.'" width="'.$ResizedWidth.'"></td>';
					echo '</tr>';
					echo '</table>';
					...
					$query = "INSERT INTO `slides` (`slide_full_img`,`slide_thumb_img`,`rdate`) VALUES ('".$DestRandImageName."', '".$thumb_DestRandImageName."', now())";
					mysql_query($query)or die(mysql_error());
					//mysql_query("INSERT INTO myImageTable (ImageName, ThumbName, ImgPath) VALUES ($DestRandImageName, $thumb_DestRandImageName, 'uploads/')");
