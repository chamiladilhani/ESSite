...
if(isset($_GET['did']))
{
	$user->deleteUserGroup($_GET['did']);	
	redirect('admin-user-group.php');
...
<div id="wrapper">
	...
	<div id="maincontentcontainer" class="s_contact">
		<div id="maincontent">
			...
			<div class="breadcrumb">
            	<a href="index.php">Home</a> &raquo; <a href="admin-panel.php">Administrator</a> &raquo; User Group
            </div>
			...
			<div class="section group">
                ...
                <div class="col span_3_of_5">              	
                	<h3 style="text-align:center;background:#42B8DD"><span style="color:#fff" class="contactJobtitle">Manage User Group</span></h3>
            		<div class="section group" style="background:#DDD;">
	            		<div class="col span_4_of_4">
	            			<div style="padding:0 10px;width:93%;margin:0 auto;">
								<form id="UserGroupForm" action="" method="post">

									<h3 style="margin-bottom:-5px;"><span style="color:#555;" class="contactJobtitle">Create New Group</span></h3>
			                        <div class="section group">
			                        	...
			                        	<div class="col span_1_of_6">
			                        		<select name="p_name" id="p_name">
					                        	<option value="">predefined group</option>
					                        	<option value="Administrator">Administrator</option>
					                        	<option value="Organizer">Organizer</option>
					                        	<option value="Lecturer">Lecturer</option>
					                        	<option value="Deleget">Deleget</option>
					                        	<option value="Support">Support</option>
					                        </select>
			                        	</div>
			                        	<div class="col span_1_of_6"><label> or </label></div>
			                        	<div class="col span_1_of_6">
			                        		<input type="text" name="n_name" id="n_name" placeholder="write new">

			                        	</div>
			                        	<div class="col span_1_of_6">
			                        		<button type="submit" name="submitUserGroup" id="submitUserGroup" style="margin-left:10px" class="button-secondary pure-button">Ready</button>
			                        	</div>			                        	
			                        	
			                        </div> 
			                        <div class="section group">
			                        	<p style="color:red;font-size:12px;display:none;" id="userGroup"></p>
			                        </div>
									...
									foreach($userList as $singleUser){
										...
										echo '
											<tr class="pure-table-odd">
									            ...
									            <td>
									            	<a onClick="return checkMe()" title="Delete" href="admin-user-group.php?did='.$singleUser->id.'"><img src="img/icons/delete.png"></a>
	...
	<script>
		jQuery("#p_name").on("change", function(){		

			var val = $(this).val();

			if (val != "") {
		        $("#n_name").attr("disabled", "disabled"); 
		    } 
		    else{
		    	$("#n_name").removeAttr("disabled");
		    }
		});
	</script>
