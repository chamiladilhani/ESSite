...
<div id="wrapper">
	...
	<div id="maincontentcontainer" class="s_contact">
		<div id="maincontent">
			...
			<div class="breadcrumb">
            	<a href="index.php">Home</a> &raquo; <a href="admin-panel.php">Administrator</a> &raquo; <a href="admin-news-add.php">Site Maintain</a> &raquo; Edit <?php echo $details->title; ?>
            </div>
                ...
                <div class="col span_3_of_5">              	
            		...
            		<div class="section group" style="background:#DDD;">
	            		<div class="col span_4_of_4">
	            			...
	            			<h3><span style="color:#555;" class="contactJobtitle">News Add</span></h3>
								<form id="newsForm" action="" method="post">									
			                        			                        
			                        <label for="">Title <i>*</i></label>  
			                        <input type="text" id="title" name="title" value="<?php echo $details->title; ?>" required placeholder="Please enter news title">
           
			                        <p><label for="">Description <i>*</i></label>
                        			<textarea id="description" name="description" tabindex="4" required><?php echo $details->description; ?></textarea></p>
									...
									<input type="hidden" name="nid" value="<?php echo $details->id; ?>">

			                        <button type="submit" name="updateNews" id="updateNews" class="button-secondary pure-button">Update</button>
			                    </form>  
			                </div>      
            			</div>
            		</div> 
	...
	<script src="ajax-js-files/news-edit-validation.js"></script>
