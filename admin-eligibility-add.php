...
if(isset($_GET['did']))
{
	$user->deleteEligibility($_GET['did']);	
	redirect('admin-eligibility-add.php');
...
<div id="wrapper">
	...
	<div id="maincontentcontainer" class="s_contact">
		<div id="maincontent">
			...
			<div class="breadcrumb">
            	<a href="index.php">Home</a> &raquo; <a href="admin-panel.php">Administrator</a> &raquo; Eligibility Area
            </div>
			...
			<div class="section group">
                ...
                <div class="col span_3_of_5">              	
                	<h3 style="text-align:center;background:#42B8DD"><span style="color:#fff" class="contactJobtitle">Eligibility</span></h3>
            		<div class="section group" style="background:#DDD;">
	            		<div class="col span_4_of_4">
	            			<div style="padding:0 10px;width:93%;margin:0 auto;">
								<form id="eligibilityForm" action="" method="post">

									<h3 style="margin-bottom:-5px;"><span style="color:#555;" class="contactJobtitle">Create New Eligibility Level</span></h3>
			                        
			                        <div style="margin-top: 10px;display:none;" id="sent-form-msg" class="success-box alert">
										New eligibility level added.						
										<a class="toggle-alert" href="#">Toggle</a>
									</div>
									<div style="margin-top: 10px;display:none;" id="error-form-msg" class="error-box alert">
										Sorry, something goes wrong.					
										<a class="toggle-alert" href="#">Toggle</a>
									</div>

			                        <div class="section group">
			                        	<input type="text" id="name" name="name" required placeholder="Eligibility level">			                        	
			                        </div> 

			                        <div class="section group">
			                        	<label for="">Select one or more <i>*</i></label>  
				                        <select required name="groups[]" id="groups" multiple class="chosen-select" tabindex="2">
				                        <?php $type = $type = array('Student' => 'Student', 'Lecturer' => 'Lecturer'); ?>
				                        	<?php 
				                        		echo array2dropdown($type);
				                        	?>
				                        </select>
			                        </div>

			                        <div class="section group">
		                        		<button type="submit" name="submitEligibility" id="subjectEligibility" class="button-secondary pure-button">Add</button>
		                        	</div>
							...
							<?php
								...
								if($userList){
									...
									<table class="pure-table">
									    <thead>
									        <tr>
									            <th style="text-align:center">Eligibility ID</th>
									...
									foreach($userList as $singleUser){
										...
										echo '
											<tr class="pure-table-odd">
									            ...
									            <td>
									            	<a onClick="return checkMe()" title="Delete" href="admin-eligibility-add.php?did='.$singleUser->id.'"><img src="img/icons/delete.png"></a>
									            	<a href="admin-eligibility-edit.php?aid='.$singleUser->id.'" title="Edit" href="#"><img src="img/icons/edit.png"></a>
									            </td>
									        </tr>
										';
									}
	...
	<script src="ajax-js-files/eligibility-add-validation.js"></script>
