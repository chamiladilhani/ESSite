...
<div id="wrapper">
		...
		<div id="maincontent">
			...
			<div class="section group">
                ...
                <div class="col span_3_of_5">              	
								...
								<form id="UserForm" action="" method="post">
			                        ...
			                        <div class="section group">
			                        	<div class="col span_2_of_4">
			                        		<input type="text" id="fname" name="fname" required placeholder="Please enter first name">
			                        	</div>
			                        	<div class="col span_2_of_4">
			                        		<input type="text" id="lname" name="lname" required placeholder="Please confirm last name">
			                        	</div>
			                        </div> 
			                        ...
			                        <select required name="role">
			                        	...
			                        	<?php 
											$role = new User();
											echo array2dropdown($role->getRoles());
										?>
			                        </select>   
			                        ...
			                        <button type="submit" id="submitUser" name="submitUser" class="button-secondary pure-button">Create New</button>
			                    </form>  
			                </div>     
            			</div>
            		</div> 
            		...
            		<div class="section group" style="background:#DDD;">
	            		<div class="col span_4_of_4">
	            			<div style="padding:0 10px;width:93%;margin:0 auto; overflow-x: auto;">
									...
									foreach($userList as $singleUser){
										...
										echo '
											<tr class="pure-table-odd">
									            ...
									            <td>
									            	<a onClick="return checkMe()" title="Delete" href="admin-user-add.php?did='.$singleUser->id.'"><img src="img/icons/delete.png"></a>
									            	<a title="Edit" href="admin-user-edit.php?uid='.$singleUser->id.'"><img src="img/icons/edit.png"></a>
									            </td>
									        </tr>
										';
									}
	...
	<script src="ajax-js-files/user-add-validation.js"></script>
