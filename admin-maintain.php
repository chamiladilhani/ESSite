...
if(isset($_GET['did']))
{
	$user->deleteNews($_GET['did']);	
	redirect('admin-maintain.php');
				
}

if(isset($_GET['sid']))
{
	$user->deleteSlider($_GET['sid']);	
	redirect('admin-maintain.php');
	...
	<div id="maincontentcontainer" class="s_contact">
		<div id="maincontent">
			...
			<div class="breadcrumb">
            	<a href="index.php">Home</a> &raquo; <a href="admin-panel.php">Administrator</a> &raquo; Site Maintain
            </div>
			...
			<div class="section group">
                ...
                <div class="col span_3_of_5">              	
                	<h3 style="text-align:center;background:#42B8DD"><span style="color:#fff" class="contactJobtitle">Maintain</span></h3>
            		
            		<div class="section group" style="background:#DDD;">
	            		<div class="col span_4_of_4">
	            			<div style="padding:0 10px;width:93%;margin:0 auto;">
	            			<h3><span style="color:#555;" class="contactJobtitle">News List</span></h3>
							<?php
								...
								if($userList){
									...
									foreach($userList as $singleUser){
										...
										if ($_SESSION['uid'] == $singleUser->publisher_id) {
											echo '
												<tr class="pure-table-odd record">
										            <td style="text-align:center">'.$singleUser->id.'</td>
										            <td>'.$singleUser->title.'</td>
										            <td>'.$singleUser->description.'</td>
										            <td>'.$singleUser->publish.'</td>
										            <td>'.$singleUser->publisher_name.'</td>
										           ';
										    if (!$singleUser->thumb) {
									        	echo '
									        		<td><a title="Image upload" href="newsimageuploader.php?nid='.$singleUser->id.'" class="defult_a_style button-success button-xsmall pure-button">Add</a></td>
									        	';
									        }
									        else{
									        	echo '
									        		<td><a title="Image" href="newsimageuploader.php?nid='.$singleUser->id.'" class="defult_a_style button-secondary button-xsmall pure-button">change</a></td>
									        	';
									        }

										    echo '
										            <td>
										            	<a onClick="return checkMe()" title="Delete" href="admin-maintain.php?did='.$singleUser->id.'"><img src="img/icons/delete.png"></a>
										            	<a href="admin-news-edit.php?nid='.$singleUser->id.'" title="Edit"><img src="img/icons/edit.png"></a>
										            </td>
										        </tr>
											';
										}										
            		...
            		<div class="section group" style="background:#DDD;">
	            		<div class="col span_4_of_4">
	            			<div style="padding:0 10px;width:93%;margin:0 auto;">
	            			<h3><span style="color:#555;" class="contactJobtitle">Slider List</span></h3>
							<?php
								$userList = $user->getSlider();
								...
								if($userList){
									...
									foreach($userList as $singleUser){
										...
										echo '
											<tr class="pure-table-odd record">
									            <td style="text-align:center;vertical-align: middle;">'.$singleUser->id.'</td>
									            <td style="width: 20%;"><img style="width:50%;vertical-align: middle;" src="'.$singleUser->thumb.'" /></td>
									           ';
									        if($singleUser->title == ""){
									        	echo '
									        		<td>No Title.</td>
									        	...
									        	echo '
									        		<td>'.current(explode("\n", wordwrap($singleUser->title, 20, "...\n"))).'</td>
									        	';
									        }
									        if($singleUser->description == ""){
									        	echo '
									        	...
									        	echo '
									        		<td>'.current(explode("\n", wordwrap($singleUser->description, 20, "...\n"))).'</td>
									        	';
									        }
									        echo '
									        	<td style="text-align:center;">'.$singleUser->order_no.'</td>
									            <td>
									            	<a onClick="return checkMe()" title="Delete" href="admin-maintain.php?sid='.$singleUser->id.'"><img src="img/icons/delete.png"></a>
									            	<a href="admin-slide-edit.php?sid='.$singleUser->id.'" title="Edit"><img src="img/icons/edit.png"></a>
									            </td>
									        </tr>
										';									
