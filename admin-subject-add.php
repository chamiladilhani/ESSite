...
if(isset($_GET['did']))
{
	$user->deleteSubject($_GET['did']);	
	redirect('admin-subject-add.php');
...
<div id="wrapper">
	...
	<div id="maincontentcontainer" class="s_contact">
		<div id="maincontent">
			...
			<div class="breadcrumb">
            	<a href="index.php">Home</a> &raquo; <a href="admin-panel.php">Administrator</a> &raquo; Subject Area
            </div>
			...
			<div class="section group">
                ...
                <div class="col span_3_of_5">              	
                	<h3 style="text-align:center;background:#42B8DD"><span style="color:#fff" class="contactJobtitle">Manage Subject</span></h3>
	            		...
	            		<div class="col span_4_of_4">
	            			<div style="padding:0 10px;width:93%;margin:0 auto;">
								<form id="subjectForm" action="" method="post">
									...
									<h3 style="margin-bottom:-5px;"><span style="color:#555;" class="contactJobtitle">Create New Subject</span></h3>
			                        <div class="section group">

			                        	<div style="display:none;" style="display:none;" id="sent-form-msg" class="success-box alert">
											New subject added.						
			                        	...
			                        	<div class="col span_1_of_2">
			                        		...
			                        		<p style="display:none;color:red;font-size:12px;" id="subjectAdd"></p>
			                        	</div>
			                        	<div class="col span_1_of_2">
			                        		<button type="submit" id="submitSubject" name="submitSubject" style="margin-left:10px" class="button-secondary pure-button">Add</button>
			                        	</div>
			                        </div> 
									...
									foreach($userList as $singleUser){
										...
										echo '
											<tr class="pure-table-odd">
									            ...
									            <td>
									            	<a onClick="return checkMe()" title="Delete" href="admin-subject-add.php?did='.$singleUser->id.'"><img src="img/icons/delete.png"></a>
									            	<a href="admin-subject-edit.php?sid='.$singleUser->id.'" title="Edit" href="#"><img src="img/icons/edit.png"></a>
									            </td>
									        </tr>
										';
									}
	...
	<script src="ajax-js-files/subject-add-validation.js"></script>
