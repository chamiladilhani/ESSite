...
if (isset($_REQUEST['sid'])) {
	$details = $user->getSubjectDetails($_REQUEST['sid']);
}
...
<div id="wrapper">
		...
		<div id="maincontent">
			...
			<div class="section group">
                ...
                <div class="col span_3_of_5">              	
                	<h3 style="text-align:center;background:#42B8DD"><span style="color:#fff" class="contactJobtitle">Edit Subject</span></h3>
								...
								<form id="subjectForm" action="" method="post">
			                        ...
			                        <div class="section group">
			                        	...
			                        	<div class="col span_1_of_2">
			                        		<input type="text" id="name" name="name" value="<?php echo $details->name ?>" required placeholder="Subject name">
			                        	</div>
			                        	<div class="col span_1_of_2">
			                        		<input type="hidden" name="sid" id="sid" value="<?php echo $details->id ?>">
			                        		<button type="submit" id="updateSubject" name="updateSubject" style="margin-left:10px" class="button-secondary pure-button">Update</button>
			                        	</div>
			                        </div> 
	...
	<script src="ajax-js-files/subject-edit-validation.js"></script>
