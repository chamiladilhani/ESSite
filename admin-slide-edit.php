...
if (isset($_REQUEST['sid'])) {
	$details = $user->getSliderDetails($_REQUEST['sid']);
}
...
<div id="wrapper">
	...
	<div id="maincontentcontainer" class="s_contact">
		<div id="maincontent">
			...
			<div class="breadcrumb">
            	<a href="index.php">Home</a> &raquo; <a href="admin-panel.php">Administrator</a> &raquo; <a href="admin-news-add.php">Site Maintain</a> &raquo; Update slider #<?php echo $details->id; ?>
            </div>
			...
			<div class="section group">
                ...
                <div class="col span_3_of_5">              	
                	<h3 style="text-align:center;background:#42B8DD"><span style="color:#fff" class="contactJobtitle">update slider #<?php echo $details->id; ?></span></h3>
	            			...
	            			<div style="padding:0 10px;width:93%;margin:0 auto;">
								<form id="slideForm" action="" method="post">
									...
									<div style="width:100%;margin:0 auto;">
										<img style="width:80%;margin-left: 10.3333%;" src="<?php echo $details->slide_full_img; ?>">
									</div>									
			                        			                        
			                        <label for="">Title <i>*</i></label>  
			                        <input type="text" id="title" name="title" value="<?php echo $details->title; ?>" placeholder="Please enter news title">
           
			                        <p><label for="">Description <i>*</i></label>
                        			<textarea id="description" name="description" tabindex="4" ><?php echo $details->description; ?></textarea></p>

                        			<label for="">Order <i>*</i></label>  
			                        <input type="text" id="order_no" name="order_no" value="<?php echo $details->order_no; ?>" placeholder="Please provide a order no">
									...
									<input type="hidden" name="sid" value="<?php echo $details->id; ?>">

			                        <button type="submit" name="updateSlide" id="updateSlide" class="button-secondary pure-button">Update</button>
			                    </form>  
			                </div>      
            			</div>
            		</div> 
	...
	<script src="ajax-js-files/slide-edit-validation.js"></script>
