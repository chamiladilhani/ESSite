...
if (isset($_REQUEST['aid'])) {
	$details = $user->getEligibilityDetails($_REQUEST['aid']);
}
...
<div id="wrapper">
		...
		<div id="maincontent">
			...
			<div class="section group">
                ...
                <div class="col span_3_of_5">              	
                	<h3 style="text-align:center;background:#42B8DD"><span style="color:#fff" class="contactJobtitle">Eligibility Edit</span></h3>
	            		...
	            		<div class="col span_4_of_4">
	            			<div style="padding:0 10px;width:93%;margin:0 auto;">
								<form id="eligibilityForm" action="" method="post">
									...
									<h3 style="margin-bottom:-5px;"><span style="color:#555;" class="contactJobtitle">Edit <?php echo $details->name; ?></span></h3>
			                        
			                        <div style="margin-top: 10px;display:none;" id="sent-form-msg" class="success-box alert">
										Eligibility level updated.						
		                        	...
		                        	<div class="section group">
		                        		<input type="text" id="name" name="name" value="<?php echo $details->name; ?>" required placeholder="Eligibility level">
		                        	</div>
			                         ...
			                         <div class="section group">
				                        ...
				                        <?php 
				                        	$type = array('Student' => 'Student', 'Lecturer' => 'Lecturer');				                        

			                        		foreach($type as $k => $v){

												$Type_exploded = explode(",", $details->groups);

												if(in_array($k, $Type_exploded))  {
			                        ...
			                        <div class="section group">
		                        		<input type="hidden" id="aid" name="aid" value="<?php echo $details->id; ?>">
		                        		<button type="submit" name="updateEligibility" id="updateEligibility" class="button-secondary pure-button">Update</button>
		                        	</div>
	...
	<script src="ajax-js-files/eligibility-edit-validation.js"></script>
