...
if(isset($_POST))
{
	...
	$DestinationDirectory	= 'uploads/news/'; //specify upload directory ends with / (slash)
	...
	if(resizeImage($CurWidth,$CurHeight,$BigImageMaxSize,$DestRandImageName,$CreatedImage,$Quality,$ImageType))
	{
		...
		*/
		...
		echo '<tr>';
		echo '<td align="center"><img src="uploads/news/'.$ThumbPrefix.$NewImageName.'" alt="Thumbnail"></td>';
		echo '</tr><tr>';
		echo '<td align="center"><img src="uploads/news/'.$NewImageName.'" alt="Resized Image"></td>';
		echo '</tr>';
		echo '</table>';
		...
		$query = "UPDATE `news` SET full = '$full_img', thumb = '$thumb_img' WHERE id = ". mysql_real_escape_string($_POST['nid']);
