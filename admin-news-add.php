...
<div id="wrapper">
	            		...
	            		<div class="col span_4_of_4">
	            			...
	            			<h3><span style="color:#555;" class="contactJobtitle">News Add</span></h3>
								<form id="newsForm" action="" method="post">									
			                        ...
			                        <input type="text" id="title" name="title" required placeholder="Please enter news title">
           
			                        <p><label for="">Description <i>*</i></label>
                        			<textarea id="description" name="description" tabindex="4" required></textarea></p>

                        			<div style="display:none;margin-bottom:10px;" id="sent-form-msg" class="success-box alert">
										New news update  added.						
			                        ...
			                        <button type="submit" name="submitNews" id="submitNews" class="button-secondary pure-button">Add New</button>
			                    </form>  
			                </div>      
            			</div>
            		</div>  
	...
	<script src="ajax-js-files/news-add-validation.js"></script>
