...
if(isset($_GET['did']))
{
	...
	redirect('admin-multimedia-manage.php');
	...
	<div id="maincontentcontainer" class="s_contact">
		<div id="maincontent">
			...
			<div class="breadcrumb">
            	<a href="index.php">Home</a> &raquo; <a href="admin-panel.php">Administrator</a> &raquo; Multimedia
            </div>
			...
			<div class="section group">
                ...
                <div class="col span_3_of_5">              	
                	<h3 style="text-align:center;background:#42B8DD"><span style="color:#fff" class="contactJobtitle">Manage Multimedia</span></h3>
									...
									foreach($userList as $singleUser){
										...
										echo '
											<tr class="pure-table-odd">
									            ...
									            <td>
									            	<a onClick="return checkMe()" title="Delete" href="admin-multimedia-manage.php?did='.$singleUser->id.'"><img src="img/icons/delete.png"></a>
