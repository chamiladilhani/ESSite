...
if(isset($_GET['did']))
{
	...
	redirect('admin-resource-add.php');
...
<div id="wrapper">
	...
	<div id="maincontentcontainer" class="s_contact">
		<div id="maincontent">
			...
			<div class="breadcrumb">
            	<a href="index.php">Home</a> &raquo; <a href="admin-panel.php">Administrator</a> &raquo; Resources
            </div>
			...
			<div class="section group">
                ...
                <div class="col span_3_of_5">              	
                	<h3 style="text-align:center;background:#42B8DD"><span style="color:#fff" class="contactJobtitle">Resource Add</span></h3>
	            		...
	            		<div class="col span_4_of_4">
	            			<div style="padding:0 10px;width:93%;margin:0 auto;">
								<form id="resourceForm" action="" method="post">									
			                        ...
			                        <input type="text" id="name" name="name" required placeholder="Please enter resource name">

			                        <div id="showMe" style="display:none;">
									    <label for="">No of Seats </label>  
				                        <input type="text" id="no_of_seats" name="no_of_seats" placeholder="Please Enter no of seats">
                        			...
                        			<textarea id="description" name="description" tabindex="5" required></textarea></p>
			                        ...
			                        <button type="submit" name="submitResource" id="submitResource" class="button-secondary pure-button">Confirm</button>
			                    </form>  
			                </div>      
            			</div>
            		</div>
									...
									foreach($userList as $singleUser){
										...
										echo '
											<tr class="pure-table-odd">
									            <td style="text-align:center">'.$singleUser->type.'</td>
									            <td>'.$singleUser->name.'</td>
									            <td>'.$singleUser->no_of_seats.'</td>
									            <td>'.$singleUser->location.'</td>
									            <td>'.$singleUser->description.'</td>
									            <td>
									            	<a onClick="return checkMe()" title="Delete" href="admin-resource-add.php?did='.$singleUser->id.'"><img src="img/icons/delete.png"></a>
									            	<a href="admin-resource-edit.php?rid='.$singleUser->id.'" title="Edit" href="#"><img src="img/icons/edit.png"></a>
									            </td>
									        </tr>
										';
									}
	...
	<script src="ajax-js-files/resource-add-validation.js"></script>
